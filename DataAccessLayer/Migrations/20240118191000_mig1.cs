        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ExamMinute = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrueChoice = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExamAnswers_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ExamAnswers_ExamAssignments_ExamAssignmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamAnswers_AppUserId",
                table: "ExamAnswers",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ExamAnswers_ExamAssignmentId",
                table: "ExamAnswers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionCategories_ExamId",
